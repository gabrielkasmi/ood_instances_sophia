...
- The folder [`misc`](https://github.com/gabrielkasmi/ood_instances_sophia/tree/main/misc) contains miscellaneous scripts and notebooks that have been used to compute the sanity checks and folder `misc/data`. This folder contains the files used to generate the results of the poster.
