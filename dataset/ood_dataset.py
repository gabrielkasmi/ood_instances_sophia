...
"""
Generates a dataset containing 20,000 samples (10 +, 10 -) with 2 types of instances
and two types of backgrounds, both unseed in the PITW original dataset. 
"""
...
parser.add_argument('--target_directory', default = 'PITW_urban', help = "Location of the target images")
...
def generate_complete_dataset(counts, target_directory, background_directory, arrays_directory, crop = False):
    ...
    for count, dataset in zip(counts, ["test"]) : 
